<x-app-layout >
    <div style="background-image: url('{{ asset('images/space.jpg.png') }}'); background-size: fit; background-position: center;" >
    <div class="max-w-2xl mx-auto p-4 sm:p-6 lg:p-8" >
        <form method="POST" action="{{ route('chirps.store') }}">
            ...
            <textarea
                ...
                style="background-color: rgba(21, 25, 30, 0.5);  color: white;"
            >{{ old('message') }}</textarea>
            <x-input-error :messages="$errors->get('message')" class="mt-2" />
            <x-primary-button class="mt-4" style="background-color: rgba(40, 27, 27, 0.5); color: white;">{{ __('Post') }}</x-primary-button>
        </form>
        <div class="mt-6 shadow-sm rounded-lg divide-y" style="background-color: rgba(21, 25, 30, 0.5); ">
